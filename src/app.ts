import { toNumber } from '@detachhead/ts-helpers/dist/functions/Number.js'
...
export const host = `http://192.168.1.101:${port}`
...
app.get('/ipa/:owner/:repo/:assetId', async (request, response) => {
    ...
    try {
        ...
        response.setHeader('Content-Disposition', 'attachment; filename="app.ipa"')
